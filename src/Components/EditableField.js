      ...
      <InputGroup className="my-1 flex-nowrap">
        {
          ...
          <InputGroup.Text
            className="bg-currency fw-bold border-0 text-secondary px-2">
            <span className="border_me border-2 rounded-circle d-flex align-items-center justify-content-center small" style={{width: '20px', height: '20px'}}>
              {this.props.cellData.leading}
            </span>
          </InputGroup.Text>
        }
        <Form.Control
          className={this.props.cellData.className}
