...
import { RouterHOC } from "../Redux/Wrapper/InvoiceWrapper";
              ...
              <Form.Group className="my-3">
                ...
                <InputGroup className="my-1 flex-nowrap">
                  <Form.Control
                    ...
                    onChange={(event) => this.editField(event)}
                    className="bg-dark2 border"
                    placeholder="0.0"
                    min="0.00"
                    step="0.01"
                    max="100.00"
                  />
                  <InputGroup.Text className="bg-dark2 fw-bold text-secondary small">
                    %
                  </InputGroup.Text>
                </InputGroup>
              </Form.Group>
...
export default connect(mapStateToProps)(RouterHOC(InvoiceForm));
